...
import com.al70b.core.adapters.SearchPageAdapter;
...
public class UserSearchFragment extends Fragment {
    ...
    private SearchPageAdapter mPagerAdapter;
    private int currentPosition = 1;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_search_parent, container, false);
        ...
        SlidingTabLayout slidingTabLayout = (SlidingTabLayout) viewGroup.findViewById(R.id.sliding_tabs_searchA);
