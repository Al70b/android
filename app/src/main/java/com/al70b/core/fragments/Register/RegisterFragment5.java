...
public class RegisterFragment5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_register_5, container, false);
        ...
        /*String str = getString(R.string.accept_terms_of_use_message);
        ...
        }, str.indexOf(getString(R.string.terms)), str.indexOf(getString(R.string.privacy)) + getString(R.string.privacy).length(), 0);
