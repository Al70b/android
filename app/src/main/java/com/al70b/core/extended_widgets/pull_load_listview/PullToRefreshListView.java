package com.al70b.core.extended_widgets.pull_load_listview;
...
public class PullToRefreshListView extends ListView implements OnScrollListener {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_UP:
                ...
                if (noMoreLoads) {
                    noMoreLoadsHeader();
                } else if (getFirstVisiblePosition() == 0 && mRefreshState != REFRESHING) {
    ...
    public void setNoMore(boolean f) {
        noMoreLoads = f;
        noMoreLoadsHeader();
    ...
    private class OnClickRefreshListener implements OnClickListener {
        ...
        public void onClick(View v) {
            if (mRefreshState != REFRESHING && !noMoreLoads) {
                prepareForRefresh();
                onRefresh();
            }
        }
